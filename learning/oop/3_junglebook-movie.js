...
3. Derive can override the feature but can still use the base class feature using this keyword (to call object member, we need to use "this.") if that feature doesn't exist already else we need to use super keyword.

IMP: super keyword is used to refer base class features.
example: super.interval();
